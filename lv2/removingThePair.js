...
/**
 * -- 풀이
 * stack을 이용해서 인접한 두 문자가 동일하면 제거하는 작업을 반복합니다.
 * stack의 마지막 문자와 현재 문자가 같으면 stack에서 마지막 문자를 제거합니다.
 * 다르면 현재 문자를 stack에 추가 합니다.
 * 문자열 순회가 끝난 후 stack이 비어 있으면 모든 짝이 맞는 문자가 제거된 것이므로 1을 반환하고, 
 * 그렇지 않으면 0을 반환합니다.
 */
function solution(s) {
  let stack = [];
