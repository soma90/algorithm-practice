...
function solution(n, k) {
  ...
  //console.log(n.toString(k).split('0').filter(el => isPrime(Number(el))))
  return n.toString(k).split('0').filter(el => isPrime(Number(el))).length;
}
